...
console.log("SESSION DOWNLOADED COMPLETED ⚡️")
})})}
...
console.log("CONNECTING TERRA-MD...🪐");
...
console.log('TERRA-MD CONNECTED TO WHATSAPP SUCCESS ✅')

let up = `*╭──────────────●*
> *ᴛᴇʀʀᴀ ᴍᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ꜱᴇᴇ ᴛʜᴇ ᴍᴇɴᴜ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴇɴᴊᴏʏ 🫧*

> *ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴛᴇʀʀᴀ ᴍᴅ*

*https://whatsapp.com/channel/0029Vaz2G3gL2ATyrE9Ma20u*

*╭⊱★彡[ᴛᴇʀʀᴀ ᴍᴅ]彡★⊱╮*
*│- 📂REPO NAME:* *TERRA-MD*
*│- 📃DESCRIPTION:* *whatsapp bot more feature by igwe*
*│- 🪐CREATOR:* *LORD IGWE*
*│- 🌐URL:* *https://github.com/LORD-IGWE/TERRA-MD*

*TERRA ITS ACTIVE AND READY*\n\n*PREFIX: ${prefix}*

*╰──────────────●*`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/SyPjHpd.jpeg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("24105730123")){
if(isReact) return
m.react("👑")
}
